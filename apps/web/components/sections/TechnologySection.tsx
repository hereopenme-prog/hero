...
const nodes = [
  {
    ...
    icon: <Store size={20} className="text-[#00D084]" strokeWidth={1.5} />,
  },
  {
    label: 'HERE OPEN DEVICE',
    sub: 'Installed in the shop.',
    icon: <Cpu size={20} className="text-[#00D084]" strokeWidth={1.5} />,
  },
  {
    label: 'NETWORK / CONNECTIVITY',
    sub: 'Stays connected.',
    icon: <Signal size={20} className="text-[#00D084]" strokeWidth={1.5} />,
  },
  {
    label: 'HERE OPEN PLATFORM',
    sub: 'Real-time intelligence.',
    icon: <Cloud size={20} className="text-[#00D084]" strokeWidth={1.5} />,
  },
  {
    label: 'CUSTOMER-FACING EXPERIENCE',
    sub: 'Visible to customers.',
    icon: <Globe size={20} className="text-[#00D084]" strokeWidth={1.5} />,
  },
  {
    label: 'CUSTOMERS',
    sub: 'Know before they go.',
    icon: <Users size={20} className="text-[#00D084]" strokeWidth={1.5} />,
  },
];

export function TechnologySection() {
  return (
    <Section id="technology" className="bg-[#0A0F14]">
          ...
          <div className="grid grid-cols-6 gap-4">
            {nodes.map((n) => (
              <motion.div key={n.label} variants={scaleIn} className="text-center">
                <div className="relative mx-auto w-16 h-16 mb-4 rounded-full bg-[#0F1923] border border-[#00D08440] flex items-center justify-center shadow-[0_0_28px_#00D08414]">
                  {n.icon}
                </div>
                <p className="font-display font-bold text-[0.72rem] tracking-widest text-[#E8EDF2]">
                  {n.label}
                </p>
        ...
        >
          <div className="relative">
            ...
            {nodes.map((n) => (
              ...
              >
                <div className="relative z-10 w-14 h-14 rounded-full bg-[#0F1923] border border-[#00D08440] flex items-center justify-center flex-shrink-0 shadow-[0_0_24px_#00D08414]">
                  {n.icon}
                </div>
                <div>
                  <p className="font-display font-bold text-[0.75rem] tracking-widest text-[#E8EDF2]">
                    {n.label}
                  </p>
