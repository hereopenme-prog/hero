...
const scaleRows = [
  {
    icon: <Factory size={16} className="text-[#00D084]" />,
    title: 'Manufacturing Partnerships',
    caption: 'Designed as potential supply relationships.',
  },
  {
    icon: <ShoppingCart size={16} className="text-[#00D084]" />,
  ...
  {
    icon: <Fingerprint size={16} className="text-[#00D084]" />,
    title: 'Secure Device Identity',
    caption: 'Each device with a unique identity.',
  },
  {
    icon: <Lock size={16} className="text-[#00D084]" />,
    title: 'Authenticated Access',
    caption: 'Controlled, role-based use.',
  },
  {
    icon: <Layers size={16} className="text-[#00D084]" />,
...
export function ScalabilitySection() {
  return (
    <Section id="scalability" className="bg-[#080C10]">
      ...
      <Container className="relative z-10">
        ...
        <div className="max-w-6xl mx-auto mt-14 lg:mt-16">
          ...
          <div className="hidden md:grid grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            >
              {/* Vertical connector */}
              <div className="absolute top-[20px] bottom-[20px] left-[19px] w-[1px] bg-gradient-to-b from-[#3D4F5E] via-[#00D08440] to-[#00D08480]" />
              ...
              {ladder.map((step, i) => (
                ...
                >
                  {/* Rung node */}
                  <div className="relative z-10 flex-shrink-0 w-10 h-10 rounded-full border border-[#00D08450] bg-[#0F1923] flex items-center justify-center shadow-[0_0_10px_rgba(0,208,132,0.1)]">
                  ...
                  <div
                    className="ml-auto h-[2px] rounded-full bg-[#00D084]"
            ...
            <motion.div
              ...
              variants={stagger}
            >
              <p className="font-body text-[10px] uppercase tracking-[0.2em] text-[#3D4F5E] mb-5">
          ...
          <div className="md:hidden flex flex-col gap-10">
            ...
            >
              ...
              {ladder.map((step, i) => (
                ...
                >
                  <div className="relative z-10 flex-shrink-0 w-10 h-10 rounded-full border border-[#00D08450] bg-[#0F1923] flex items-center justify-center">
                    <span className="font-body font-bold text-[10px] text-[#00D084] tracking-wider">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>
