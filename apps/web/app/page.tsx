        ...
        <div className="grid md:grid-cols-3 gap-6">
          {problems.map((p, i) => (
            <div key={i} className="card group">
              ...
              <h3 className="text-display-sm font-bold text-green-forest mb-3">{p.title}</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="bg-white border border-neutral-200 rounded-3xl p-8">
              ...
              <div className="space-y-4">
                {[
                  { icon: <Store className="w-4 h-4" />, label: 'Shop', status: 'OPEN', color: 'text-green-action' },
                  { icon: <Smartphone className="w-4 h-4" />, label: 'Owner App', status: 'Connected', color: 'text-green-action' },
                  { icon: <Cloud className="w-4 h-4" />, label: 'Cloud Platform', status: 'Syncing', color: 'text-green-action' },
                  { icon: <Wifi className="w-4 h-4" />, label: 'IoT Device', status: 'Active', color: 'text-green-action' },
                  { icon: <Eye className="w-4 h-4" />, label: 'Customers', status: 'Updated', color: 'text-green-action' },
                ].map((item, i) => (
                  <div key={i}>
                    <div className="flex items-center gap-4 bg-neutral-50 border border-neutral-200 rounded-xl px-5 py-4">
                      <div className="w-9 h-9 bg-green-action/10 rounded-lg flex items-center justify-center text-green-action">
                        {item.icon}
                      </div>
                    ...
                    {i < 4 && (
                      <div className="flex justify-center py-1">
                        <div className="w-px h-4 bg-green-action/20" />
                      </div>
                    )}
                  </div>
                ))}
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-display font-extrabold text-green-forest text-display-lg tracking-tight mb-6">
              Meet <span className="text-green-action">HERE OPEN</span>
            </h2>
            <p className="text-body-lg text-neutral-500 leading-relaxed mb-8 max-w-[480px]">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-green-action/10 rounded-lg flex items-center justify-center text-green-action">
                    {f.icon}
                  </div>
                  <span className="text-[15px] font-medium text-black">{f.text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {steps.map((s, i) => (
            <div key={i} className="relative">
              <div className="card text-center">
                <div className="w-12 h-12 bg-green-action/8 border border-green-action/15 rounded-xl flex items-center justify-center text-green-action mx-auto mb-4">
                  {s.icon}
                </div>
                <p className="text-[10px] text-green-action font-bold uppercase tracking-widest mb-2">Step {s.num}</p>
                <h3 className="text-[15px] font-bold text-green-forest mb-1.5">{s.title}</h3>
        ...
        <div className="md:hidden space-y-4">
          {steps.map((s, i) => (
            <div key={i} className="card flex items-start gap-4">
              <div className="w-10 h-10 bg-green-action/8 border border-green-action/15 rounded-lg flex items-center justify-center text-green-action flex-shrink-0">
                {s.icon}
              </div>
              <div>
                <p className="text-[10px] text-green-action font-bold uppercase tracking-widest mb-1">Step {s.num}</p>
      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-4 mt-8">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  <CheckCircle className="w-4 h-4 text-green-action mt-0.5 flex-shrink-0" />
                  <span className="text-body-sm text-neutral-500">{b}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="w-[300px] bg-white border border-neutral-200 rounded-3xl p-5 overflow-hidden">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-green-action/10 rounded-xl flex items-center justify-center">
                  <Store className="w-5 h-5 text-green-action" />
                </div>
                <div>
                  <p className="text-[13px] font-semibold text-black">Sharma General Store</p>
                  <p className="text-[11px] text-neutral-500">0.5 km away · Grocery</p>
                </div>
              </div>

              <div className="flex items-center gap-2 mb-4">
                <span className="w-2 h-2 bg-green-action rounded-full animate-status-pulse" />
                <span className="text-[13px] font-bold text-green-action">OPEN</span>
                <span className="text-[10px] text-neutral-500 ml-auto">Updated just now</span>
              </div>

              <div className="space-y-3">
                <div className="bg-green-action/[0.06] border border-green-action/15 rounded-xl p-4">
                  <p className="text-[10px] text-green-action font-semibold uppercase tracking-wider mb-1">New Offer</p>
                  <p className="text-[13px] font-semibold text-black">10% off on all groceries</p>
                  <p className="text-[11px] text-neutral-500 mt-1">Expires in 2 days</p>
                </div>
                <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-4">
                  <p className="text-[10px] text-neutral-500 font-semibold uppercase tracking-wider mb-1">Announcement</p>
                  <p className="text-[13px] font-medium text-black">New arrivals every Saturday</p>
                </div>
              </div>

              <div className="flex gap-2 mt-5">
                <button className="flex-1 py-2.5 bg-green-action text-white text-[12px] font-bold rounded-lg">
                  Navigate
                </button>
                <button className="flex-1 py-2.5 border border-neutral-200 text-black text-[12px] font-medium rounded-lg">
                  Follow
                </button>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {[
            ...
            <div key={i} className="card-static text-center py-8">
              <p className="text-display-md font-extrabold text-green-action mb-2">{item.stat}</p>
    ...
    <section className="section relative">
      ...
      <Container className="relative z-10">
        ...
        <div className="hidden lg:grid lg:grid-cols-5 gap-4">
          {phases.map((p, i) => (
            <div key={i} className="relative">
              <div className={`card-static py-6 ${p.status === 'active' ? 'border-green-action/20' : ''}`}>
                <p className="text-[11px] text-green-action font-bold uppercase tracking-widest mb-1">{p.year}</p>
                <h3 className="text-[15px] font-bold text-green-forest mb-3">{p.title}</h3>
                <ul className="space-y-2">
                  {p.items.map((item, j) => (
                    <li key={j} className="flex items-start gap-2">
                      <CheckCircle className={`w-3.5 h-3.5 mt-0.5 flex-shrink-0 ${p.status === 'active' ? 'text-green-action' : 'text-neutral-300'}`} />
        ...
        <div className="lg:hidden space-y-4">
          {phases.map((p, i) => (
            <div key={i} className={`card-static ${p.status === 'active' ? 'border-green-action/20' : ''}`}>
              <div className="flex items-center gap-3 mb-3">
                <span className="text-[11px] text-green-action font-bold uppercase tracking-widest">{p.year}</span>
                <span className={`text-[10px] px-2 py-0.5 rounded-full ${p.status === 'active' ? 'bg-green-action/10 text-green-action' : 'bg-neutral-100 text-neutral-500'}`}>
                  {p.status === 'active' ? 'Active' : 'Planned'}
                </span>
              </div>
              <h3 className="text-[15px] font-bold text-green-forest mb-2">{p.title}</h3>
              <ul className="space-y-2">
                {p.items.map((item, j) => (
                  <li key={j} className="flex items-start gap-2">
                    <CheckCircle className={`w-3.5 h-3.5 mt-0.5 flex-shrink-0 ${p.status === 'active' ? 'text-green-action' : 'text-neutral-300'}`} />
      ...
      <Container>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="card group">
              <div className="w-8 h-8 bg-green-action/8 border border-green-action/15 rounded-lg flex items-center justify-center text-green-action mb-4">
                <Zap className="w-4 h-4" />
              </div>
              <h3 className="text-[15px] font-bold text-green-forest mb-2">{item.title}</h3>
    ...
    <section className="section relative overflow-hidden">
      ...
      <Container className="relative z-10 text-center">
        <h2 className="font-display font-extrabold text-green-forest text-display-lg tracking-tight mb-5">
          ...
          <br />
          <span className="text-green-action">Smarter?</span>
        </h2>
        <p className="text-body-lg text-neutral-500 max-w-[500px] mx-auto mb-10">
