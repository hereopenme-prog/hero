  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'var(--a14)', animation: 'heroOrbDrift 9s ease-in-out infinite' }}
      />
      <div
      ...
      <Container className="relative z-10 py-20">
        <AnimatedSection variant={scaleIn} className="flex flex-col items-center text-center">
          ...
          <div className="my-6" style={{ width: 80, height: 1, background: 'var(--border)' }} />
          ...
          <p
            className="mt-4 font-body font-normal text-[1rem] text-[var(--ink-dim)] leading-[1.7]"
            style={{ maxWidth: 400 }}
          >
          ...
          >
            <p className="font-body font-medium text-[0.65rem] text-[var(--ink-dim)] uppercase tracking-[0.15em]">
              Shop Status
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-12">
            <Link
              href="/"
              className="active:scale-[0.97] inline-flex items-center justify-center rounded-lg px-7 py-3.5 font-display font-semibold text-[15px] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_32px_var(--a40)]"
              style={{ background: 'linear-gradient(135deg, var(--accent), #00B4D8)', color: 'var(--bg)' }}
            >
              Go Back Home
            </Link>
            <Link
