        ...
        <Container>
          <div className="max-w-content mx-auto">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-display-sm font-bold text-white mb-4">1. Acceptance of Terms</h2>
              ...
              <div>
                <h2 className="text-display-sm font-bold text-white mb-4">2. Use of Services</h2>
                <p className="text-body-md text-muted-light leading-relaxed">
              ...
              <div>
                <h2 className="text-display-sm font-bold text-white mb-4">3. Account Registration</h2>
                <p className="text-body-md text-muted-light leading-relaxed">
              ...
              <div>
                <h2 className="text-display-sm font-bold text-white mb-4">4. Intellectual Property</h2>
                <p className="text-body-md text-muted-light leading-relaxed">
              ...
              <div>
                <h2 className="text-display-sm font-bold text-white mb-4">5. Limitation of Liability</h2>
                <p className="text-body-md text-muted-light leading-relaxed">
              ...
              <div>
                <h2 className="text-display-sm font-bold text-white mb-4">6. Termination</h2>
                <p className="text-body-md text-muted-light leading-relaxed">
              ...
              <div>
                <h2 className="text-display-sm font-bold text-white mb-4">7. Contact</h2>
                <p className="text-body-md text-muted-light leading-relaxed">
                  For questions about these Terms, contact us at{' '}
                  <span className="text-neon bg-neon/10 px-1.5 py-0.5 rounded">legal@hereopen.in</span>.
                </p>
              </div>
            </div>
          </div>
